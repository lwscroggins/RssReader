...
gulp.task('dev', ['build-html', 'build-css', 'browserify']); //one-time build for html, css, and js
gulp.task('fresh', ['nuke', 'build-html', 'build-css', 'browserify']); //nukes build/ and starts over
